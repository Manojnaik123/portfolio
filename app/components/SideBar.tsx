...
const SideBar = () => {
  ...
  return (
    <div className={`${sidebarOpen ? "w-64" : "w-[60px]"} hidden md:flex flex-col h-screen bg-white border-r border-[#f0f0f0] transition-all duration-200 ease-in-out overflow-hidden`}>
      <SidebarContent
